...
$(document).ready(function($) {
    ...
    //    $( ".main-navigation.navigation-top-header" ).load( config.root + "/assets/external/_navigation.html" );
	//	navigationStyle = "topHeader";
    //}
    //else if( $body.hasClass('navigation-off-canvas') ) {
    //    $( ".main-navigation.navigation-off-canvas" ).load( config.root + "/assets/external/_navigation.html" );
