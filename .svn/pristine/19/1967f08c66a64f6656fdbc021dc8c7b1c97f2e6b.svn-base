...
/* ====Custom==== */
function TDM_Notification(p_status, p_title, p_message, p_timeout) {
    if (p_timeout === 'undefined') { p_timeout  = 2000}
    if (p_status == "error" || p_status == "ERROR" || p_status == "0") {
        iziToast.error({
            title: p_title,
            message: p_message,
            position: 'topRight',
    ...
    } else if (p_status == "success" || p_status == "SUCCESS" || p_status == "1") {
        iziToast.success({
            title: p_title,
            message: p_message,
            position: 'topRight',
    ...
    else if (p_status == "warning" || p_status == "WARNING" || p_status == "2") {
        iziToast.warning({
            title: p_title,
            message: p_message,
            position: 'topRight',
