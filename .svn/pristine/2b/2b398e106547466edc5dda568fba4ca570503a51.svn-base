...
$(function () {
    ...
    http.get("/api/AreaAnalysis/GetAllProvince", {}, function (data) {
        $("#allProvince").empty();
...
function searchProjectImpactList(start, count, keyword) {
    ...
    http.get("/api/AreaAnalysis/GetAllProjectImpact", { start, count, subject_id, subject_name, prov_name, publish_date }, function (data) {
        {
