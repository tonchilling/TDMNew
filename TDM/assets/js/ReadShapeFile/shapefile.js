...
(function (window, undefined) {
    ...
    if (window.document && window.Worker) {
        ...
        var Shapefile = function (o, callback) {
            ...
            if (o.shp) w.postMessage(["Load", o.shp])
    ...
    var Shapefile = function (o, callback) {
        ...
        if (!!o.lastModifiedDate)
            this.handleFile(o);
        else if (o instanceof Blob || o instanceof File)
            this.handleFile(o);
        else
            //this.handleUri(o);
            throw "Not support input type"
    }
    ...
    Shapefile.prototype = {
        ...
        handleUri: function (o) {
            ...
            xhr.open("GET", o, false)
            xhr.overrideMimeType("text/plain; charset=x-user-defined")
            xhr.send()

            if (200 != xhr.status)
                throw "Unable to load " + o + " status: " + xhr.status
        ...
        handleFile: function (o) {
            ...
            if (!!window.FileReader) {
                ...
                this.onFileLoad(reader.readAsBinaryString(o));
            }
        },
